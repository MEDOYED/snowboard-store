const IconGooglePlay = ({ className }) => {
  return (
    <svg
      className={className}
      width="120px"
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <defs>
          <linearGradient
            ...
            <stop stopColor="#00C3FF" /> <stop offset="1" stopColor="#1BE2FA" />
          </linearGradient>
          <linearGradient
            ...
            y2="15.8176"
            gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFCE00" /> <stop offset="1" stopColor="#FFEA00" />
          </linearGradient>
          <linearGradient
            ...
            y2="17.8937"
            gradientUnits="userSpaceOnUse">
            <stop stopColor="#DE2453" /> <stop offset="1" stopColor="#FE3944" />
          </linearGradient>
          <linearGradient
            ...
            y2="13.7365"
            gradientUnits="userSpaceOnUse">
            <stop stopColor="#11D574" /> <stop offset="1" stopColor="#01F176" />
          </linearGradient>
        </defs>
      </g>
    </svg>
