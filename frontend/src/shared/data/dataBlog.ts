...
const dataBlog: TypeBlog[] = [
  {
    ...
    description: [
      ...
      {
        descriptionTitle: "Какая самая комфортная погода для бега?",
        descriptionText:
      ...
      {
        descriptionTitle: "Что влияет на выбор одежды?",
        descriptionText:
      ...
      {
        descriptionTitle: "Что надеть в -1°C",
        descriptionText:
      ...
      {
        descriptionTitle: "Что надеть в +4°C",
        descriptionText:
